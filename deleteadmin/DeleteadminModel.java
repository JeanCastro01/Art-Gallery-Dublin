...
public class DeleteadminModel {
  ...
  public boolean adminDelete(String index) {

        try {
            // Building the query
            String query= "DELETE FROM admin WHERE admin_id = '" + index + "'";
 ...
 private void closings(){
        try {            
            ...
            Logger.getLogger(DeleteadminModel.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
